import { Btn, Card, PageHeader } from "@/presentation/components/ui/ui-kit";
import { PageMeta } from "@/presentation/components/PageMeta";

export function SettingsPage() {
  return (
    <div>
      <PageMeta title="Configurações" description="Preferências da conta e organização." />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-5 space-y-4">
          ...
          {["Alertas de saldo baixo", "Eventos de pods (start, stop, erro)", "Resumo semanal de consumo"].map((n) => (
